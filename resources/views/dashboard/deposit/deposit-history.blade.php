        ...
        <div class="nk-content-body">
            ...
            <ul class="nk-nav nav nav-tabs">
                <li class="nav-item active current-page">
                    <a class="nav-link active" href="{{ route('user.transactions') }}">Deposits</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="tranx-col">
                            <div class="tranx-info">
                                ...
                                <div class="tranx-data">
                                    <div class="tranx-label">{{ optional($item->payment_method)->name  }} Deposit <span class="ml-3"> {!! $item->status() !!}</span></div>
